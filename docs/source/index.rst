...
.. warning::
   This documentation refers to the development version 0.9 of TexText and is
   under heavy construction.  For the current stable version 0.8.x go to the
   `TexText Wiki <https://github.com/textext/textext/wiki>`_
